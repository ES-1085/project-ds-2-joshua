...
### Calculate abundance per cover board
...
```{r test-wilcox-n_pc-df}
wilcox.test(df$n_pc ~ df$ft)
```
Report: I found no significant difference in mean abundance per cover board between mixed deciduous and hemlock forests (Wilcoxon rank sum test, W = 1198, P = 0.982).
